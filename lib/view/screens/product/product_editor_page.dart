...
class ProductEditorPage extends StatefulWidget {
  const ProductEditorPage({Key? key}) : super(key: key);
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: TextField(
                                          keyboardType: TextInputType.number,
                                          controller: productNewDiscountAmountController,
                                          decoration: InputDecoration(
                                              isDense: true,
                                              border: OutlineInputBorder(
                                                borderRadius: BorderRadius.circular(12),
                                              ...
                                              label:
                                                  const Text("Jumlah pengurangan harga")),
                                        ),
                                      ),
                                      Row(
                                                ...
                                                if (discountAmount.isNotEmpty &&
                                                  ...
                                                  setState(() {
                                                    productDiscounts.add(ProductDiscount(
                                                      id: const Uuid().v4(),
                                                      amount: double.parse(discountAmount
                                                          .replaceAll('.', '')
                                                          .replaceAll('-', '')),
                                                      discountName:
